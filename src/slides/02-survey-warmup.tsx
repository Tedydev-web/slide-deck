...
const questions = [
  {
    vi: (
      <>
        Đã thử <span style={{ color: theme.colors.accent }}>Cursor / Copilot / Claude Code</span> trong 3 tháng qua?
      </>
    ),
  ...
  },
  {
    vi: (
      <>
        Kỳ vọng cao, thực tế…{' '}
        <span style={{ color: theme.colors.accent }}>thất vọng</span>?
      </>
    ),
    kr: '기대는 높았는데… 실망하셨나요?',
  },
  {
    vi: (
      <>
        Đã từng nói{' '}
        <span style={{ color: theme.colors.accent }}>'AI code ẩu, không dùng được'</span>?
      </>
    ),
